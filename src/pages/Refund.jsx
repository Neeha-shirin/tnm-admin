...
const Refund = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('refundPolicy');
    const updated = localStorage.getItem('refundPolicyLastUpdated');
    if (saved) {
      setSavedContent(saved);
      setContent(saved);
    } else {
      setContent('<p>Enter your comprehensive refund policy here. Include details about eligibility, timeframes, process, and contact information.</p>');
    }
  ...
  const handleSave = async () => {
    if (!content || !content.trim() || content.includes('Enter your comprehensive refund policy here')) {
    ...
    try {
      ...
      localStorage.setItem('refundPolicy', content);
      ...
      localStorage.setItem('refundPolicyLastUpdated', now);
      setSavedContent(content);
      setLastUpdated(now);
      setIsEditing(false);
      showNotification('Refund policy published successfully!', 'success');
    } catch (err) {
      showNotification('Failed to save refund policy. Please try again.', 'error');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleDelete = () => {
    ...
    setIsDeleting(true);
    setTimeout(() => {
      if (window.confirm('Are you sure you want to delete the refund policy? This action cannot be undone.')) {
        localStorage.removeItem('refundPolicy');
        localStorage.removeItem('refundPolicyLastUpdated');
        const defaultContent = '<p>Enter your comprehensive refund policy here. Include details about eligibility, timeframes, process, and contact information.</p>';
        setContent(defaultContent);
        setSavedContent('');
        setLastUpdated('');
        setIsEditing(false);
        showNotification('Refund policy has been deleted', 'warning');
      }
      setIsDeleting(false);
    }, 300);
  };
  ...
  return (
    <div className="">
      ...
      <div className={`fixed top-5 right-5 z-50 transition-all duration-500 transform ${
        notification.show 
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Manage your customer refund guidelines</p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-6 p-4 bg-gray-50 rounded-xl mb-6 transition-all duration-300">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-900">{getWordCount(content)}</p>
                  </div>
                </div>
                ...
                <div className="p-6 bg-white border-b border-gray-100">
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-500">
                      Use the toolbar to format your refund policy. Include all necessary details for your customers.
                    </p>
                  </div>
                  ...
                  {savedContent ? (
                      ...
                      <div className="mt-8 pt-6 border-t border-gray-200">
                        <div className="flex flex-wrap items-center justify-between gap-4">
                          <div className="flex items-center gap-2 text-sm text-gray-500">
                            ...
                            This refund policy is legally binding for your organization.
                          </div>
                          <button
                            onClick={handleEdit}
                    ...
                    <div className="text-center py-16">
                      <div className="max-w-md mx-auto">
                        ...
                        <h3 className="text-xl font-semibold text-gray-900 mb-2">No Refund Policy Created</h3>
                        <p className="text-gray-600 mb-6">
                          Create a comprehensive refund policy to inform your customers about your return and refund procedures.
                        </p>
                        <button
                          onClick={handleEdit}
