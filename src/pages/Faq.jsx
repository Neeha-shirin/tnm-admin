...
const AdminFaqPage = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    const savedFaqs = localStorage.getItem("adminFaqs");
    if (savedFaqs) {
    ...
    <div className="">
            ...
            <div className="text-center">
              ...
              {deleteIndex !== null && faqs[deleteIndex] && (
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                  <p className="text-red-800 font-medium text-sm">{faqs[deleteIndex].question}</p>
                </div>
              )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full mx-auto transform animate-scaleIn">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Clear All FAQs</h3>
              <p className="text-gray-600 mb-6">
                This will permanently delete all {faqs.length} FAQs. This action cannot be undone.
              </p>
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                <p className="text-red-800 font-medium text-sm text-center">
                  You're about to delete {faqs.length} question{faqs.length !== 1 ? 's' : ''}
                </p>
              </div>
              <div className="flex gap-3 justify-center">
                <button
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-3">FAQ Management</h1>
          <p className="text-gray-600 text-lg">Manage your frequently asked questions with ease</p>
        </div>
        ...
        <div id="faq-form" className="bg-white rounded-2xl p-6 mb-8 shadow-sm border border-gray-200/60">
            ...
            <div className="text-center py-16 bg-gradient-to-br from-white to-blue-50/50 rounded-2xl border-2 border-dashed border-gray-300">
              {faqs.length === 0 ? (
                <>
                  ...
                  <h3 className="text-2xl font-bold text-gray-700 mb-3">No FAQs Yet</h3>
                  <p className="text-gray-500 text-lg mb-6 max-w-md mx-auto">
                    Start building your knowledge base by adding your first frequently asked question.
                  </p>
                ...
                <>
                  ...
                  <p className="text-gray-500 text-lg mb-6 max-w-md mx-auto">
                    We couldn't find any FAQs matching "<span className="text-gray-700 font-medium">{searchTerm}</span>". Try different keywords.
                  </p>
                  <button
                    ...
                    >
                      <div className="flex items-start space-x-4 flex-1">
                        <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center mt-1 transition-colors ${
                          activeIndex === originalIndex ? 'bg-blue-500' : 'bg-blue-100 group-hover:bg-blue-200'
                        }`}>
                          <span className={`text-sm font-semibold ${
                            activeIndex === originalIndex ? 'text-white' : 'text-blue-600'
                          }`}>Q</span>
                        </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <svg
                          className={`w-5 h-5 text-gray-400 transform transition-transform duration-300 group-hover:text-blue-500 ${
                            activeIndex === originalIndex ? "rotate-180 text-blue-500" : ""
                          }`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                      ...
                      <div className="px-6 pb-5 pt-2 border-t border-gray-100 animate-fadeIn">
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            <p className="text-gray-700 leading-relaxed pt-1 whitespace-pre-wrap">{faq.answer}</p>
                          </div>
                        </div>
                      </div>
                    )}
